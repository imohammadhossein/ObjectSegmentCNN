...
- We computed the diagnostic features of each image in each category with different convolutional networks (VGG16, ResNet50, EfficientNetb0,  AlexNet and DenseNet-168), Different saliency models (GBVS, Itti, Signature, Simpsal and Spectral) and finally with Human visual perception system.
